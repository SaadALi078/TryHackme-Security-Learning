...
- Lab: FakeBank (Gobuster directory enumeration)
- Tool used: Gobuster
- Learned how attackers find hidden web pages

### Day 3 – TryHackMe (SOC Basics)
- Topic: Security Operations Center (SOC)
- Tool: SIEM (Security Information and Event Management)
- Learned how SOC monitors networks using SIEM alerts
- Identified malicious activities from logs
- Analyzed failed logins and unauthorized access attempts
